...
NetInfo <- read.xlsx(paste0(working_dir, 'connectional_variability_axis_hcpd.xlsx'))
axis <- NetInfo$Value
...
ggsave(paste0(working_dir, 'connectional_variability_axis_hcpd.png'), plot = p, width = 13, height = 6, units = "cm", dpi = 1200)

########################################################################################
NetInfo <- read.xlsx(paste0(working_dir, 'connectional_variability_axis_hcp.xlsx'))
...
ggsave(paste0(working_dir, 'connectional_variability_axis_hcp.png'), plot = p, width = 13, height = 6, units = "cm", dpi = 1200)
