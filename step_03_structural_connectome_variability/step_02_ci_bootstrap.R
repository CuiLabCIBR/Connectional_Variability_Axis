...
rm(list = ls())
working_dir <- 'F:/Cui_Lab/Projects/Connectional_Variability_Axis/step_03_structural_connectome_variability/'
...
write.table(corr_results, paste0(working_dir, 'bootstrap_corr_results.csv'), sep = ",", col.names = TRUE, row.names = FALSE)