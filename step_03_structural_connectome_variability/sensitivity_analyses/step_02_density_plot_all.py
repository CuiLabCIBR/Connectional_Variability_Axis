...
if __name__ == '__main__':
    ...
    csv_files = [file for file in all_files if file.startswith('hcp') and file.endswith('.csv')]
    
    # Loop through each file and process it
    for csv_name in csv_files:
        input_file = file_path + csv_name
        var_name = os.path.splitext(csv_name)[0]
    
        print(f"Processing file: {csv_name}")
        
        out_path = file_path + 'density_plot_' + var_name + '.png' 
